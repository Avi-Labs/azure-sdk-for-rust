...
impl<'a> UpdateOrMergeEntityBuilder<'a> {
    ...
    where
        E: Serialize,
    {
        // this is safe to unwrap, but it should probably made lazy_static
        // to avoid recreating it at each call.
        let method_merge = Method::from_bytes(b"MERGE").unwrap();
